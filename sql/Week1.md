...
데이터가 저장되는 장소: MySQL, Oracle 등과 같은 데이터베이스에 주로 저장<br>
#### OLTP(Online Transaction Processing)
거래를 하기 위해 사용되는 데이터베이스<br>보류/중간 상태가 없음<br>데이터의 추가 및 변경이 많이 발생<br>SQL을 사용해 데이터를 추출할 수 있으나 분석 전용으로 만들어지지 않아서 쿼리 속도가 느릴 수 있음<br>
#### SQL(Structured Query Language)
데이터베이스에서 데이터를 가지고 올 때 사용하는 언어<br>데이터베이스의 데이터 관리를 위해 설계된 특수 목적의 프로그램<br>
#### Row
행, 하나의 row가 하나의 고유한 데이터<br>
Raw 데이터: 원본 데이터<br>
#### Column
각 데이터의 특정 속성값<br>
#### 테이블에 저장된 형태: 엑셀, 스프레드시트와 유사<br>
## 2-1. 데이터 활용 Overview
